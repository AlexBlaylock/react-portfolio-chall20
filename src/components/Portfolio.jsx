  ...
  const projects = [
    {
      id: 1,
      title: 'Game Pop!',
      description: 'My last group project, focused on building a fullstack application. A higher/lower browser game. Built in React. I did the styling, using mainly MUI.',
